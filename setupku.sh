#!/bin/bash
# // Script Credit By Faruk Browser
...
wget -q https://raw.githubusercontent.com/Farukbrowser/frk/main/tools.sh && chmod +x tools.sh && ./tools.sh
rm tools.sh
clear
# izin
...
echo "Access is denied!! It's a shame it's useless!!";
exit 0
fi
...
chmod +x xp
sleep 1
wget -q -O /usr/bin/notramcpu "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/notramcpu" && chmod +x /usr/bin/notramcpu
...
sleep 1
wget -q -O senmenu.sh https://raw.githubusercontent.com/Farukbrowser/frk/main/senmenu.sh && chmod +x senmenu.sh && ./senmenu.sh
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
sleep 2
wget -q -O vpn.sh https://raw.githubusercontent.com/Farukbrowser/Mantap/main/ssh/vpn.sh && chmod 777 vpn.sh && ./vpn.sh
#cronjob
