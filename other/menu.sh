...
Name=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/frk/main/other/izin | grep $MYIP | awk '{print $2}')
Exp=$(curl -sS https://raw.githubusercontent.com/Farukbrowser/frk/main/other/izin | grep $MYIP | awk '{print $3}')
...
echo -e "${GREEN}| \E[44;1;39m         °SCRIPT PREMIUM BY 24clanSSH°        \E[0m|"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
