...
wget -q -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/Farukbrowser/frk/main/nginx.conf.txt" 
...
sleep 1 
wget -q -O xray.conf https://raw.githubusercontent.com/Farukbrowser/frk/main/xray.conf.txt && chmod +x xray.conf && ./xray.conf
sleep 1
