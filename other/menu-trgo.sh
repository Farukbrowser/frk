...
clear 
echo -e "[33mттттттттттттттттттттттттттттттттттт[0m"
echo -e "[0;100;33m      тЂ TROJAN Go MENU тЂ          [0m"
echo -e "[33mттттттттттттттттттттттттттттттттттт[0m"
echo -e ""
echo -e " [[36m1[0m] Create Account Trojan Go "
#echo -e " [[36m2[0m] Trial Account Trojan Go "
echo -e " [[36m2[0m] Renew Account Trojan Go "
echo -e " [[36m3[0m] Delete Account Trojan Go "
echo -e " [[36m4[0m] Check User Login Trojan Go"
echo -e ""
echo -e   ""
