...
wget -q -O /usr/bin/infosc "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/limit/info.sh" && chmod +x /usr/bin/infosc
wget -q -O /usr/bin/pelanggar "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/limit/pelanggar.sh" && chmod +x /usr/bin/pelanggar

wget -q -O /root/status "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/statushariini"
wget -q -O /usr/bin/menu "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/menu.sh"
wget -q -O /usr/bin/delv2ray "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/tes/delv2ray.sh"
...
wget -q -O /usr/bin/autoreboot "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/autoreboot.sh"
wget -q -O /usr/bin/restart "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/restart.sh"
wget -q -O /usr/bin/tendang "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/tendang.sh"
wget -q -O /usr/bin/clearlog "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/clearlog.sh"
wget -q -O /usr/bin/running "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/running.sh"
...
wget -q -O /usr/bin/menu-vmess "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/tes/menu-vmess.sh"
#wget -q -O /usr/bin/menu-socks "https://raw.githubusercontent.com/Agunxzzz/XrayCol/main/minacantik/menu-socks.sh"
wget -q -O /usr/bin/menu-ss "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/tes/menu-ss.sh"
wget -q -O /usr/bin/menu-trojan "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/tes/menu-trojan.sh"
...
wget -q -O /etc/issue.net "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/issue.net"
wget -q -O /root/versi "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/versibasic"
wget -q -O /usr/bin/updatsc "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/menu/update.sh"
wget -q -O /usr/bin/menu-backup "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/menu-backup.sh"
wget -q -O /usr/bin/fix "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/cf.sh"
wget -q -O /usr/bin/setting "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/Themes/setting.sh"
wget -q -O /usr/bin/menu-ipsec "https://raw.githubusercontent.com/Farukbrowser/frk/main/other/ipsec/menu-ipsec.sh"
wget https://raw.githubusercontent.com/Farukbrowser/frk/main/all/wslow.sh
wget https://raw.githubusercontent.com/Farukbrowser/frk/main/other/backup/set-br.sh
bash set-br.sh
wget https://raw.githubusercontent.com/Farukbrowser/frk/main/other/Themes/thema.sh
