...
sleep 2
clear
wget https://raw.githubusercontent.com/Farukbrowser/frk/main/all/ssh-vpn/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Install Xray
echo -e "${tyblue}.------------------------------------------.${NC}"
...
sleep 2
clear
wget https://raw.githubusercontent.com/Farukbrowser/frk/main/all/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/Farukbrowser/frk/main/all/insshws.sh && chmod +x insshws.sh && ./insshws.sh
